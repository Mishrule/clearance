                ...
                <div class="col-lg-12 col-md-12 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="row">
                            ...
                            <label for="clearanceStatus">Clearance Type</label>
                                <select class="custom-select" id="clearanceStatus" name="clearanceStatus">
                            ...
                            <div class="col-md-4 col-lg-4">
                                ...
                                <select class="custom-select" id="approvedClearanceType" name="approvedClearanceType">
                                    ...
                                    <option value="Department Clearance (Departmental Dues)">Department Clearance (Departmental Dues)</option>
...
<script>
    $(document).ready(function() {
        ...
        $('#approvedClearanceType').change(function() {
            ...
            let clearanceStatus = $('#clearanceStatus').val();

            $.ajax({
                url: '../scripts/clearanceStatusScript.php',
                method: 'POST',
                data: {
