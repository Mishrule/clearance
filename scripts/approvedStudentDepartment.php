<?php
    ...
    if(isset($_POST['searchStudent'])){
        ...
        // $hallStudentMsg = '';
            ...
            <tbody>
            ';
            $approveClearanceStatusSQL = "SELECT DISTINCT clearance_id, student_id, student_name, clearance_type, clearance_status FROM clearance WHERE student_id LIKe '%$searchStudent%' AND year_group='$approvedClearanceYearGroup' AND clearance_type='Department Clearance (Departmental Dues)'";
